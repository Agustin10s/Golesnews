...
const LEAGUES_CONFIG = [
  ...
  { id: LEAGUES.CHAMPIONS_LEAGUE, label: 'Champions League', flag: '🏆', anchor: 'champions' },
  { id: LEAGUES.SERIE_A, label: 'Serie A', flag: '🇮🇹', anchor: 'seriea' },
  { id: LEAGUES.BUNDESLIGA, label: 'Bundesliga', flag: '🇩🇪', anchor: 'bundesliga' },
];
  ...
  return (
    <div style={{ maxWidth: 1300, margin: '0 auto', padding: '18px 1rem' }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ fontSize: 12, color: 'var(--text3)' }}>Premier League · La Liga · Champions League · Serie A · Bundesliga</p>
      </div>
